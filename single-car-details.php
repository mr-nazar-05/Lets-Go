                        ...
                        <div class="single-sidebar">
                            ...
                            <div class="sidebar-body">
                                <div class="social-icons text-center">
                                    <a href="https://www.facebook.com/nazar.soudagar.05" target="_blank"><i class="fa fa-facebook"></i></a>
                                    <a href="#" target="_blank"><i class="fa fa-twitter"></i></a>
                                    <!-- <a href="#" target="_blank"><i class="fa fa-behance"></i></a> -->
                                    <a href="https://www.linkedin.com/in/nazar-soudagar-5b6844214" target="_blank"><i class="fa fa-linkedin"></i></a>
                                    <!-- <a href="#" target="_blank"><i class="fa fa-dribbble"></i></a> -->
                                    <a href="https://instagram.com/___mustaqeexm?igshid=YmMyMTA2M2Y=" target="_blank"><i class="fa fa-instagram"></i></a>
                                </div>
                            </div>
                        </div>
